...
export default function SphereAnimation() {
    ...
    useEffect(() => {
        ...
        const sphereEl = wrapperRef.current.querySelector('.sphere-animation') as HTMLElement;
        ...
        const cleanupResize = fitElementToParent(sphereEl, 0);
    ...
    return (
        <div className="relative w-full h-full flex items-center justify-center p-10" ref={wrapperRef}>
            <div className="animation-wrapper w-full relative" style={{ paddingBottom: '100%' }}>
                <div className="sphere-animation absolute top-1/2 left-1/2 w-145 h-145 -mt-[290px] -ml-[290px]">
